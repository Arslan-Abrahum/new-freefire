  ...
  return (
    <div className="h-auto bg-[rgb(20,27,61)] min-h-screen p-2 flex justify-around items-center">
      ...
      <div className="h-[auto] w-[1000px] setting-main flex items-center flex-col justify-center bg-[#171F45] mx-auto my-5 py-5">
        ...
        <div className='w-full m-auto flex items-center justify-center mb-5 gap-5'>
                                  ...
                                  <div className="text-center mt-4">
                                    {
                                      paymentStatus ? (
                                        <>
                                          ...
                                          <h2 className="text-2xl font-bold text-white ">{selectedPackage.uc_amount}k Diamonds</h2>
                                          <h3 className="text-lg text-white">SENDING SUCCESSFULLY <br /> VIA FreeFire ID: {searchVal} </h3>
                                          <Link className='border border-red-600 inline-block mt-4 px-4 py-2 rounded-lg text-white hover:bg-red-600 transition duration-300' onClick={handleback} to="/homepage/successfulfreefire">Home</Link>
                                        </>
                                      ) : (
                                        <>
                                          <div className="parent-loader">
